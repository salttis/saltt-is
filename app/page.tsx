...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">{`I’m Juri Saltbacka — a "Full Power" Senior Software Engineer and Lead with a passion for building focused, scalable systems and guiding teams toward delivering real value with minimal overhead. I take a pragmatic approach to Extreme Programming, emphasizing simplicity, collaboration, and fast feedback loops over ceremony and bloat.`}</p>
